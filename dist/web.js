function t(t) {
    return Object.keys(t).reduce(((e,r)=>{
        ...
        !s(n.value) || function(t) {
            return "[object Function]" === Object.prototype.toString.call(t)
        }(n.value) || Array.isArray(n.value) || (e[r].value = Object.assign({}, n.value)),
    ...
    return class extends s {
        ...
        connectedCallback() {
            if (!this.__initialized) {
                    ...
                    return Object.keys(n).forEach((t=>{
                        ...
                        Object.defineProperty(s, t, {
                            ...
                            set(e) {
                                var s = n.value;
                                n.value = e,
                                n.reflect && r(this, n.attribute, n.value);
                                for (let r = 0, n = this.__propertyChangedCallbacks.length; r < n; r++)
                ...
                var s = function(t) {
                    return Object.keys(t).reduce(((e,r)=>(e[r] = t[r].value,
                    e)), {})
                }(this.props)
                  , i = this.Component
                  , a = n;
        ...
        lookupProp(t) {
            if (o)
                return i.find((e=>t === e || t === o[e].attribute))
        }
        get renderRoot() {
    ...
    return r=>{
        ...
        return a ? a.prototype.Component = r : ((a = o(n, function(t) {
            return t ? Object.keys(t).reduce(((e,r)=>{
                ...
                e[r].parse = "parse"in e[r] ? e[r].parse : "string" != typeof e[r].value,
                e
            }
            ), {}) : {}
        }(e))).prototype.Component = r,
...
function x(t, e) {
    ...
    return [$.bind(r), t=>("function" == typeof t && (t = t(r.value)),
    E(r, t))]
}
function k(t, e, r) {
    T(R(t, e, !1, u))
...
function C(t, e, r) {
    return r = r ? Object.assign({}, c, r) : c,
...
function P(t) {
    return null !== f && (null === f.cleanups ? f.cleanups = [t] : f.cleanups.push(t)),
    t
}
function $() {
    var t;
    return this.sources && this.state && (this.state === u ? T(this) : (t = y,
    y = null,
    B((()=>j(this)), !1),
    y = t)),
    b && (t = this.observers ? this.observers.length : 0,
    b.sources ? (b.sources.push(this),
    b.sourceSlots.push(t)) : (b.sources = [this],
    b.sourceSlots = [t]),
...
function E(t, e, r) {
    var s = t.value;
    return t.comparator && t.comparator(s, e) || (t.value = e,
    t.observers && t.observers.length && B((()=>{
        for (let s = 0; s < t.observers.length; s += 1) {
            var e = t.observers[s]
              , r = g && g.running;
            r && g.disposed.has(e),
            (r ? e.tState : e.state) || ((e.pure ? y : m).push(e),
            e.observers && I(e)),
            r || (e.state = u)
        }
        if (1e6 < y.length)
...
function T(t) {
    ...
    function(t, e, r) {
        ...
        try {
            ...
            return t.pure && (t.state = u,
            t.owned && t.owned.forEach(M),
            t.owned = null),
            t.updatedAt = r + 1,
            z(e)
        }
        (!t.updatedAt || t.updatedAt <= r) && (null != t.updatedAt && "observers"in t ? E(t, s) : t.value = s,
        t.updatedAt = r)
    }(b = f = t, t.value, s),
    b = r,
    f = e)
...
function O(t) {
    if (0 !== t.state) {
        ...
        for (let s = r.length - 1; 0 <= s; s--) {
            var e;
            (t = r[s]).state === u ? T(t) : t.state === p && (e = y,
            y = null,
            B((()=>j(t, r[0])), !1),
            y = e)
        }
...
function M(t) {
    ...
    if (t.sources)
        for (; t.sources.length; ) {
            var r, s, n = t.sources.pop(), o = t.sourceSlots.pop(), i = n.observers;
            i && i.length && (r = i.pop(),
            s = n.observerSlots.pop(),
            o < i.length) && (i[r.sourceSlots[s] = o] = r,
            n.observerSlots[o] = s)
        }
    if (t.owned) {
        for (e = t.owned.length - 1; 0 <= e; e--)
            M(t.owned[e]);
        t.owned = null
    }
    if (t.cleanups) {
        for (e = t.cleanups.length - 1; 0 <= e; e--)
            t.cleanups[e]();
        t.cleanups = null
    }
    t.state = 0,
...
function V(t, ...e) {
    ...
    return e.push(Object.keys(n).filter((t=>!r.has(t)))),
    e.map((e=>{
        var r = {};
        ...
        ()=>{
            ...
            S((()=>{
                ...
                if (0 === v)
                    ...
                    a && (f = new Array(v)),
                    g = 0,
                    b = Math.min(i, v); g < b && s[g] === u[g]; g++)
                        ;
                    for (b = i - 1,
                    y = v - 1; b >= g && y >= g && s[b] === u[y]; b--,
                    y--)
                        l[y] = n[b],
                        d[y] = o[b],
                        a && (f[y] = a[b]);
...
function st(t, e, r) {
    ...
    const n = ()=>{
        ...
        (r ? e.content.firstChild : e.content).firstChild
    }
    ;
...
function at(t, e={}, r, s) {
    const n = {};
    return s || k((()=>n.children = dt(t, e.children, n.children))),
    k((()=>e.ref && e.ref(t))),
    k((()=>function(t, e, r, s, n={}, o=!1) {
        e = e || {};
        for (const s in n)
            s in e || "children" !== s && (n[s] = ut(t, s, null, n[s], r, o));
        for (const a in e) {
            var i;
            "children" === a ? s || dt(t, e.children) : (i = e[a],
            n[a] = ut(t, a, i, n[a], r, o))
        }
    }(t, e, r, !0, n, !0))),
    n
}
...
function ut(t, e, r, s, n, o) {
    ...
    return "style" === e ? function(t, e, r) {
        ...
        e = e || {},
        r = r || {})
            null == e[o] && s.removeProperty(o),
            delete r[o];
        for (o in e)
            (n = e[o]) !== r[o] && (s.setProperty(o, n),
            r[o] = n);
        return r
        ...
        i = s.length; o < i; o++) {
            var l = s[o]
              , c = !!e[l];
            l && "undefined" !== l && r[l] !== c && c && (ht(t, l, !0),
            r[l] = c)
        }
        return r
    }(t, r, s) : r === s ? s : ("ref" === e ? o || r(t) : "on:" === e.slice(0, 3) ? (o = e.slice(3),
    s && t.removeEventListener(o, s),
    r && t.addEventListener(o, r)) : "oncapture:" === e.slice(0, 10) ? (o = e.slice(10),
    s && t.removeEventListener(o, s, !0),
    r && t.addEventListener(o, r, !0)) : "on" === e.slice(0, 2) ? (o = e.slice(2).toLowerCase(),
    !(u = tt.has(o)) && s && (s = Array.isArray(s) ? s[0] : s,
    t.removeEventListener(o, s)),
    (u || r) && (function(t, e, r, s) {
        if (s)
            Array.isArray(r) ? (t["$$" + e] = r[0],
            t[`$$ ${e}Data`] = r[1]) : t["$$" + e] = r;
    ...
    u) && nt([o])) : "attr:" === e.slice(0, 5) ? ot(t, e.slice(5), r) : (h = "prop:" === e.slice(0, 5)) || (l = K.has(e)) || !n && ((c = function(t, e) {
        return "object" == typeof (t = Z[t]) ? t[e] ? t.$ : void 0 : t
    }(e, t.tagName)) || (a = J.has(e))) || (i = t.nodeName.includes("-")) ? (h && (e = e.slice(5),
    a = !0),
    "class" === e || "className" === e ? it(t, r) : !i || a || l ? t[c || e] = r : t[function(t) {
...
function pt(t) {
    ...
    Object.defineProperty(t, "currentTarget", {
        ...
        if (s && !r.disabled) {
            var n = r[e + "Data"];
            if (void 0 !== n ? s.call(r, n, t) : s.call(r, t),
            t.cancelBubble)
                return
        }
...
function dt(t, e, r, s, n) {
    ...
    if (e !== r) {
        ...
        "string" == o || "number" == o)
            if ("number" == o && (e = e.toString()),
            i) {
                let n = r[0];
                n && 3 === n.nodeType ? n.data = e : n = document.createTextNode(e),
                r = bt(t, r, s, n)
            } else
                r = "" !== r && "string" == typeof r ? t.firstChild.data = e : t.textContent = e;
        else if (null == e || "boolean" == o)
            r = bt(t, r, s);
        else {
            if ("function" == o)
                return k((()=>{
            ...
            if (Array.isArray(e)) {
                const a = [];
                if (o = r && Array.isArray(r),
                ft(a, e, r, n))
                    return k((()=>r = dt(t, a, r, s, !0))),
                    ()=>r;
                if (0 === a.length) {
                    if (r = bt(t, r, s),
                    i)
                    ...
                    o ? 0 === r.length ? gt(t, a, s) : function(t, e, r) {
                        let s = r.length
                          , n = e.length
                          , o = s
                          , i = 0
                        ...
                        for (; i < n || a < o; )
                            if (e[i] === r[a])
                                ...
                                for (; e[n - 1] === r[o - 1]; )
                                    ...
                                    o--;
                                if (n === i)
                                    for (var h = o < s ? a ? r[a - 1].nextSibling : r[o - a] : l; a < o; )
                                        t.insertBefore(r[a++], h);
                                else if (o === a)
                                    for (; i < n; )
                                        c && c.has(e[i]) || e[i].remove(),
                                        i++;
                                    ...
                                    if (null != p)
                                        if (a < p && p < o) {
                                            let s, l = i, h = 1;
                                            for (; ++l < n && l < o && null != (s = c.get(e[l])) && s === p + h; )
                                                h++;
                                            if (h > p - a)
                                                for (var d = e[i]; a < p; )
                                                    t.insertBefore(r[a++], d);
                                            else
                                                t.replaceChild(r[a++], e[i++])
                                        } else
                                            i++;
                                    else
                                        e[i++].remove()
                ...
                if (Array.isArray(r)) {
                    ...
                    null != r && "" !== r && t.firstChild ? t.replaceChild(e, t.firstChild) : t.appendChild(e);
                r = e
            } else
    ...
    for (let i = 0, a = e.length; i < a; i++) {
        ...
        if (a instanceof Node)
            ...
            if (Array.isArray(a))
                ...
                var o = String(a);
                l && 3 === l.nodeType ? (l.data = o,
                t.push(l)) : t.push(document.createTextNode(o))
            }
    }
    return n
}
...
function bt(t, e, r, s) {
    ...
    if (e.length) {
        ...
        for (let a = e.length - 1; 0 <= a; a--) {
            var o, i = e[a];
            n !== i ? (o = i.parentNode === t,
            s || a ? o && i.remove() : o ? t.replaceChild(n, i) : t.insertBefore(n, r)) : s = !0
        }
    } else
        t.insertBefore(n, r);
    return [n]
...
const xt = t=>null == t
  ...
  , _t = async t=>{
    try {
        ...
        if (n = s && s.includes("application/json") ? await r.json() : "string" != typeof t && "blob" === t.type ? await r.blob() : await r.text(),
        r.ok)
            return {
                data: n
            };
  ...
  , Ct = st('<svg viewBox="0 0 24 24"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z">')
  , St = st('<img alt="Bubble button icon">')
  , At = st('<button part="button"><svg viewBox="0 0 24 24"><path fill-rule="evenodd" clip-rule="evenodd" d="M18.601 8.39897C18.269 8.06702 17.7309 8.06702 17.3989 8.39897L12 13.7979L6.60099 8.39897C6.26904 8.06702 5.73086 8.06702 5.39891 8.39897C5.06696 8.73091 5.06696 9.2691 5.39891 9.60105L11.3989 15.601C11.7309 15.933 12.269 15.933 12.601 15.601L18.601 9.60105C18.9329 9.2691 18.9329 8.73091 18.601 8.39897Z">')
  , Pt = t=>{
    {
        const e = At()
          , r = e.firstChild;
        return e.$$click = ()=>t.toggleBot(),
        ...
        ct(e, U(X, {
            ...
            get children() {
                ...
                return k((r=>{
                    ...
                    return s !== r._v$ && (null != (r._v$ = s) ? e.style.setProperty("stroke", s) : e.style.removeProperty("stroke")),
        ...
        ct(e, U(X, {
            ...
            get children() {
                ...
                return k((r=>{
                    ...
                    return s !== r._v$3 && ot(e, "src", r._v$3 = s),
        ...
        k((s=>{
            ...
            return n !== s._v$5 && it(e, s._v$5 = n),
            o !== s._v$6 && (null != (s._v$6 = o) ? e.style.setProperty("background-color", o) : e.style.removeProperty("background-color")),
            i !== s._v$7 && (null != (s._v$7 = i) ? e.style.setProperty("right", i) : e.style.removeProperty("right")),
            a !== s._v$8 && (null != (s._v$8 = a) ? e.style.setProperty("bottom", a) : e.style.removeProperty("bottom")),
            l !== s._v$9 && (null != (s._v$9 = l) ? r.style.setProperty("fill", l) : r.style.removeProperty("fill")),
...
const jt = ({apiHost: t="http://localhost:3000", body: e})=>_t({
    method: "POST",
    url: t + "/api/v1/openai-assistants-file",
    body: e,
    type: "blob"
})
  , It = st('<input class="focus:outline-none bg-transparent px-4 py-4 flex-1 w-full text-input disabled:opacity-50 disabled:cursor-not-allowed disabled:brightness-100" type="text">')
  , Mt = t=>{
    const [e,r] = V(t, ["ref", "onInput"]);
    return (s = It()).$$input = t=>e.onInput(t.currentTarget.value),
  ...
  , [zt,qt] = (nt(["input"]),
x())
  , Dt = st('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="19px"><path d="M476.59 227.05l-.16-.07L49.35 49.84A23.56 23.56 0 0027.14 52 24.65 24.65 0 0016 72.59v113.29a24 24 0 0019.52 23.57l232.93 43.07a4 4 0 010 7.86L35.53 303.45A24 24 0 0016 327v113.31A23.57 23.57 0 0026.59 460a23.94 23.94 0 0013.22 4 24.55 24.55 0 009.52-1.93L476.4 285.94l.19-.09a32 32 0 000-58.8z">')
  , Ut = t=>{
    return at(e = Dt(), W({
        get style() {
            return {
  ...
  , Ft = st('<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-refresh" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M20 11a8.1 8.1 0 0 0 -15.5 -2m-.5 -4v4h4"></path><path d="M4 13a8.1 8.1 0 0 0 15.5 2m.5 4v-4h-4">')
  , Ht = t=>{
    {
        const e = Ft();
        return k((()=>ot(e, "stroke", t.color ?? "#3B81F6"))),
        e
    }
}
  , Gt = st('<button type="submit">')
  , Wt = st('<svg><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z">')
  , Vt = t=>{
    return at(e = Gt(), W({
        get disabled() {
  ...
  , Jt = st("<span>Send")
  , Kt = st('<div class="flex items-end justify-between chatbot-input" data-testid="input">')
  , Qt = t=>{
    const [e,r] = x(t.defaultValue ?? "");
    let s;
    const n = t=>r(t)
      , o = ()=>{
        "" !== e() && s?.reportValidity() && t.onSubmit(e()),
        r("")
    }
      , i = t=>{
    ...
    ));
    {
        ...
        ct(r, U(Vt, {
            ...
            get children() {
                var t = Jt();
                return t.style.setProperty("font-family", "Poppins, sans-serif"),
                t
            }
        }), null),
        k((e=>{
            ...
            return s !== e._v$ && (null != (e._v$ = s) ? r.style.setProperty("background-color", s) : r.style.removeProperty("background-color")),
            n !== e._v$2 && (null != (e._v$2 = n) ? r.style.setProperty("color", n) : r.style.removeProperty("color")),
            e
        }
        ), {
            _v$: void 0,
...
st('<figure data-testid="default-avatar"><svg width="75" height="75" viewBox="0 0 75 75" fill="none" xmlns="http://www.w3.org/2000/svg"><mask id="mask0" x="0" y="0" mask-type="alpha"><circle cx="37.5" cy="37.5" r="37.5" fill="#0042DA"></circle></mask><g mask="url(#mask0)"><rect x="-30" y="-43" width="131" height="154" fill="#0042DA"></rect><rect x="2.50413" y="120.333" width="81.5597" height="86.4577" rx="2.5" transform="rotate(-52.6423 2.50413 120.333)" stroke="#FED23D" stroke-width="5"></rect><circle cx="76.5" cy="-1.5" r="29" stroke="#FF8E20" stroke-width="5"></circle><path d="M-49.8224 22L-15.5 -40.7879L18.8224 22H-49.8224Z" stroke="#F7F8FF" stroke-width="5">'))
  ...
  , ee = st('<figure><img alt="Bot avatar" class="rounded-full object-cover w-full h-full">')
  , re = t=>{
...
function ce(t, e) {
    if (e) {
        if (ne.test(t))
            return t.replace(oe, (t=>ie[t]))
    } else if (ae.test(t))
        return t.replace(le, (t=>ie[t]));
    return t
}
function he(t) {
...
var ue;
(ue = Ot = Ot || {})[ue.space = 1] = "space",
ue[ue.text = 2] = "text",
ue[ue.paragraph = 3] = "paragraph",
ue[ue.heading = 4] = "heading",
ue[ue.listStart = 5] = "listStart",
ue[ue.listEnd = 6] = "listEnd",
ue[ue.looseItemStart = 7] = "looseItemStart",
ue[ue.looseItemEnd = 8] = "looseItemEnd",
ue[ue.listItemStart = 9] = "listItemStart",
ue[ue.listItemEnd = 10] = "listItemEnd",
ue[ue.blockquoteStart = 11] = "blockquoteStart",
ue[ue.blockquoteEnd = 12] = "blockquoteEnd",
ue[ue.code = 13] = "code",
ue[ue.table = 14] = "table",
ue[ue.html = 15] = "html",
ue[ue.hr = 16] = "hr";
class pe {
    gfm = !0;
...
class de {
    options;
    constructor(t) {
        this.options = t || be.options
    }
    code(t, e, r, s) {
        this.options.highlight && null != (n = this.options.highlight(t, e)) && n !== t && (r = !0,
        t = n);
    ...
    link(t, e, r) {
        if (this.options.sanitize) {
            ...
            if (0 === s.indexOf("javascript:") || 0 === s.indexOf("vbscript:") || 0 === s.indexOf("data:"))
                return r
        }
        let s = '<a href="' + t + '"';
        return e && (s += ' title="' + e + '"'),
...
class fe {
    ...
    hasRulesGfm;
    ruleCallbacks;
    constructor(t, e, r=be.options, s) {
        if (this.staticThis = t,
        this.links = e,
        this.options = r,
        this.renderer = s || this.options.renderer || new de(this.options),
        !this.links)
    ...
    static getRulesBase() {
        ...
        return this.rulesBase || ((t = {
            ...
            _inside: /(?:\[[^\]]*\]|[^\[\]]|\](?=[^\[]*\]))*/,
            _href: /\s*<?([\s\S]*?)>?(?:\s+['"]([\s\S]*?)['"])?\s*/
        }).link = new se(t.link).setGroup("inside", t._inside).setGroup("href", t._href).getRegexp(),
        t.reflink = new se(t.reflink).setGroup("inside", t._inside).getRegexp(),
        this.rulesBase = t)
    }
    ...
    static getRulesGfm() {
        var t, e, r;
        return this.rulesGfm || (t = this.getRulesBase(),
        e = new se(t.escape).setGroup("])", "~|])").getRegexp(),
        r = new se(t.text).setGroup("]|", "~]|").setGroup("|", "|https?://|").getRegexp(),
        this.rulesGfm = {
            ...t,
            escape: e,
            url: /^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/,
    ...
    static getRulesBreaks() {
        var t, e;
        return this.rulesBreaks || (t = this.getRulesGfm(),
        e = this.getRulesGfm(),
        this.rulesBreaks = {
            ...e,
            br: new se(t.br).setGroup("{2,}", "*").getRegexp(),
            text: new se(e.text).setGroup("{2,}", "*").getRegexp()
        })
    }
    setRules() {
        this.options.gfm ? this.options.breaks ? this.rules = this.staticThis.getRulesBreaks() : this.rules = this.staticThis.getRulesGfm() : this.options.pedantic ? this.rules = this.staticThis.getRulesPedantic() : this.rules = this.staticThis.getRulesBase(),
    ...
    output(t) {
        ...
        for (; t; )
            if (e = this.rules.escape.exec(t))
                ...
                let s, n;
                t = t.substring(e[0].length),
                n = "@" === e[2] ? (s = this.options.escape(":" === e[1].charAt(6) ? this.mangle(e[1].substring(7)) : this.mangle(e[1])),
                this.mangle("mailto:") + s) : s = this.options.escape(e[1]),
                ...
                !this.inLink && /^<a /i.test(e[0]) ? this.inLink = !0 : this.inLink && /^<\/a>/i.test(e[0]) && (this.inLink = !1),
                t = t.substring(e[0].length),
                r += this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(e[0]) : this.options.escape(e[0]) : e[0];
                ...
                n && n.href ? (this.inLink = !0,
                r += this.outputLink(e, n),
                this.inLink = !1) : (r += e[0].charAt(0),
                t = e[0].substring(1) + t)
                ...
                t = t.substring(e[0].length),
                r += this.renderer.text(this.options.escape(this.smartypants(e[0])));
            else if (t)
    ...
    mangle(t) {
        ...
        for (let s = 0; s < r; s++) {
            let r;
            .5 < Math.random() && (r = "x" + t.charCodeAt(s).toString(16)),
            e += "&#" + r + ";"
        }
        return e
    }
...
class ge {
    ...
    constructor(t) {
        ...
        this.token = null,
        this.options = t || be.options,
        this.renderer = this.options.renderer || new de(this.options)
    }
    static parse(t, e, r) {
        return new this(r).parse(e, t)
    }
    parse(t, e) {
        this.inlineLexer = new fe(fe,t,this.options,this.renderer),
    ...
    parseText() {
        ...
        for (var e; (e = this.getNextElement()) && e.type == Ot.text; )
            t += "\n" + this.next().text;
    ...
    tok() {
        ...
        case Ot.listStart:
            {
                let e = "";
                for (var t = this.token.ordered; this.next().type != Ot.listEnd; )
                    e += this.tok();
        ...
        case Ot.listItemStart:
            {
                let t = "";
                for (; this.next().type != Ot.listItemEnd; )
                    t += this.token.type == Ot.text ? this.parseText() : this.tok();
        ...
        case Ot.blockquoteStart:
            {
                let t = "";
                for (; this.next().type != Ot.blockquoteEnd; )
                    t += this.tok();
        ...
        case Ot.html:
            return t = this.token.pre || this.options.pedantic ? this.token.text : this.inlineLexer.output(this.token.text),
            this.renderer.html(t);
        default:
            if (this.simpleRenderers.length)
                for (let t = 0; t < this.simpleRenderers.length; t++)
                    if (this.token.type == "simpleRule" + (t + 1))
                        return this.simpleRenderers[t].call(this.renderer, this.token.execArr);
            if (t = `Token with "${this.token.type}" type was not found.`,
            !this.options.silent)
                throw new Error(t);
            console.log(t)
        }
...
class be {
    static options = new pe;
    static simpleRenderers = [];
    static setOptions(t) {
        return Object.assign(this.options, t),
        this
    }
    static setBlockRule(t, e=(()=>"")) {
        return ye.simpleRules.push(t),
        this.simpleRenderers.push(e),
        this
    }
    static parse(t, e) {
        try {
    ...
    static debug(t, e=this.options) {
        ...
        let s = t.slice();
        return (e = new ge(e)).simpleRenderers = this.simpleRenderers,
        e = e.debug(r, t),
        {
            tokens: s = s.map((t=>{
                t.type = Ot[t.type] || t.type;
                var e = t.line;
                return delete t.line,
                e ? {
                    line: e,
                    ...t
                } : t
    ...
    static callParser(t, e, r) {
        var s;
        return this.simpleRenderers.length ? ((s = new ge(r)).simpleRenderers = this.simpleRenderers,
        s.parse(e, t)) : ge.parse(t, e, r)
    }
    static callMe(t) {
...
class ye {
    ...
    static getRulesBase() {
        ...
        return this.rulesBase || ((t = {
            ...
            bullet: /(?:[*+-]|\d+\.)/,
            item: /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/
        }).item = new se(t.item,"gm").setGroup(/bull/g, t.bullet).getRegexp(),
        t.list = new se(t.list).setGroup(/bull/g, t.bullet).setGroup("hr", "\\n+(?=\\1?(?:[-*_] *){3,}(?:\\n+|$))").setGroup("def", "\\n+(?=" + t.def.source + ")").getRegexp(),
        e = "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:/|[^\\w\\s@]*@)\\b",
        t.html = new se(t.html).setGroup("comment", /<!--[\s\S]*?-->/).setGroup("closed", /<(tag)[\s\S]+?<\/\1>/).setGroup("closing", /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/).setGroup(/tag/g, e).getRegexp(),
        t.paragraph = new se(t.paragraph).setGroup("hr", t.hr).setGroup("heading", t.heading).setGroup("lheading", t.lheading).setGroup("blockquote", t.blockquote).setGroup("tag", "<" + e).setGroup("def", t.def).getRegexp(),
        this.rulesBase = t)
    }
    static getRulesGfm() {
        var t, e, r, s;
        ...
        e.paragraph = new se(t.paragraph).setGroup("(?!", `(?!${r}|${s}|`).getRegexp(),
        this.rulesGfm = e)
    }
    ...
    setRules() {
        this.options.gfm ? this.options.tables ? this.rules = this.staticThis.getRulesTable() : this.rules = this.staticThis.getRulesGfm() : this.rules = this.staticThis.getRulesBase(),
    ...
    getTokens(t, e, r) {
        let s, n = t;
        t: for (; n; )
            if ((s = this.rules.newline.exec(n)) && (n = n.substring(s[0].length),
            ...
            s = this.rules.code.exec(n)) {
                ...
                for (let t = 0; t < i.align.length; t++)
                    /^ *-+: *$/.test(i.align[t]) ? i.align[t] = "right" : /^ *:-+: *$/.test(i.align[t]) ? i.align[t] = "center" : /^ *:-+ *$/.test(i.align[t]) ? i.align[t] = "left" : i.align[t] = null;
                var a = s[3].replace(/\n$/, "").split("\n");
                ...
                n = n.substring(s[0].length);
                var l, c = s[2], h = (this.tokens.push({
                    type: Ot.listStart,
                    ordered: 1 < c.length
                }),
                s[0].match(this.rules.item)), u = h.length;
                let t, e = !1;
                for (let s = 0; s < u; s++) {
                    let o = h[s];
                    l = o.length,
                    -1 !== (o = o.replace(/^ *([*+-]|\d+\.) +/, "")).indexOf("\n ") && (l -= o.length,
                    o = this.options.pedantic ? o.replace(/^ {1,4}/gm, "") : o.replace(new RegExp("^ {1," + l + "}","gm"), "")),
                    !this.options.smartLists || s === u - 1 || c === (l = this.staticThis.getRulesBase().bullet.exec(h[s + 1])[0]) || 1 < c.length && 1 < l.length || (n = h.slice(s + 1).join("\n") + n,
                    s = u - 1),
                    t = e || /\n\n(?!\s*$)/.test(o),
                    s !== u - 1 && (e = "\n" === o.charAt(o.length - 1),
                    t = t || e),
                ...
                for (let t = 0; t < d.align.length; t++)
                    /^ *-+: *$/.test(d.align[t]) ? d.align[t] = "right" : /^ *:-+: *$/.test(d.align[t]) ? d.align[t] = "center" : /^ *:-+ *$/.test(d.align[t]) ? d.align[t] = "left" : d.align[t] = null;
                var f = s[3].replace(/(?: *\| *)?\n$/, "").split("\n");
                ...
                if (e && (s = this.rules.paragraph.exec(n)))
                    ...
                    throw new Error("Infinite loop on byte: " + n.charCodeAt(0) + `, near text '${n.slice(0, 30)}...'`)
            }
        return {
            tokens: this.tokens,
            links: this.links
...
const me = st('<div class="flex justify-end mb-2 items-end guest-container"><span class="px-4 py-2 mr-2 whitespace-pre-wrap max-w-full chatbot-guest-bubble" data-testid="guest-bubble">')
  , ve = (be.setOptions({
    isNoP: !0
}),
t=>{
    let e;
    A((()=>{
        e && (e.innerHTML = be.parse(t.message))
    }
    ));
    {
        const r = me()
        ...
        return "function" == typeof e ? lt(e, s) : e = s,
        ...
        k((e=>{
            ...
            return r !== e._v$ && (null != (e._v$ = r) ? s.style.setProperty("background-color", r) : s.style.removeProperty("background-color")),
            n !== e._v$2 && (null != (e._v$2 = n) ? s.style.setProperty("color", n) : s.style.removeProperty("color")),
            e
        }
        ), {
            _v$: void 0,
  ...
  , we = st('<div class="flex justify-start mb-2 items-start host-container"><span class="px-4 py-2 ml-2 whitespace-pre-wrap max-w-full chatbot-host-bubble" data-testid="host-bubble">')
  , xe = (be.setOptions({
    isNoP: !0
}),
t=>{
    let e;
    A((()=>{
        if (e && (e.innerHTML = be.parse(t.message),
        t.fileAnnotations) && t.fileAnnotations.length)
            for (const n of t.fileAnnotations) {
                var r = document.createElement("button")
                  , s = (r.textContent = n.fileName,
                r.className = "py-2 px-4 mb-2 justify-center font-semibold text-white focus:outline-none flex items-center disabled:opacity-50 disabled:cursor-not-allowed disabled:brightness-100 transition-all filter hover:brightness-90 active:brightness-75 file-annotation-button",
                    ...
                    (async e=>{
                        try {
                            var r = await jt({
                              ...
                              , s = new Blob([r.data])
                              , n = window.URL.createObjectURL(s)
                              , o = document.createElement("a");
                            o.href = n,
                            o.download = e.fileName,
  ...
  , ke = st('<div class="flex items-center"><div class="w-2 h-2 mr-1 rounded-full bubble1"></div><div class="w-2 h-2 mr-1 rounded-full bubble2"></div><div class="w-2 h-2 rounded-full bubble3">')
  , _e = ()=>ke()
  , Ce = st('<div class="flex justify-start mb-2 items-start animate-fade-in host-container"><span class="px-4 py-4 ml-2 whitespace-pre-wrap max-w-full chatbot-host-bubble" data-testid="host-bubble">')
  , Se = ()=>{
    return ct((t = Ce()).firstChild, U(_e, {})),
    t;
    var t
}
  , Ae = st('<div data-modal-target="defaultModal" data-modal-toggle="defaultModal" class="flex justify-start mb-2 items-start animate-fade-in host-container hover:brightness-90 active:brightness-75"><span class="px-2 py-1 ml-1 whitespace-pre-wrap max-w-full chatbot-host-bubble" data-testid="host-bubble">')
  , Pe = t=>{
    return r = (e = Ae()).firstChild,
  ...
  , $e = (nt(["click"]),
st('<span>Powered by<a href="https://www.fisclouds.com/" target="_blank" rel="noopener noreferrer" class="lite-badge" id="lite-badge"><span> Fisclouds'))
  , Ee = "#303235"
  , Te = t=>{
    let e, r;
    const s = r=>{
        r.forEach((r=>{
            r.removedNodes.forEach((r=>{
                "id"in r && e && "lite-badge" == r.id && (console.log("Sorry, you can't remove the brand 😅"),
    ...
    ));
    {
        ...
        k((e=>{
            var n = t.poweredByTextColor ?? Ee
              , o = t.badgeBackgroundColor ?? "#ffffff"
              , i = t.poweredByTextColor ?? Ee;
            return n !== e._v$ && (null != (e._v$ = n) ? r.style.setProperty("color", n) : r.style.removeProperty("color")),
            o !== e._v$2 && (null != (e._v$2 = o) ? r.style.setProperty("background-color", o) : r.style.removeProperty("background-color")),
...
)),
{
  ...
  , Ne = "function" == typeof ArrayBuffer
  , je = t=>"function" == typeof ArrayBuffer.isView ? ArrayBuffer.isView(t) : t && t.buffer instanceof ArrayBuffer
  , Ie = ({type: t, data: e},r,s)=>Le && e instanceof Blob ? r ? s(e) : Me(e, s) : Ne && (e instanceof ArrayBuffer || je(e)) ? r ? s(e) : Me(new Blob([e]), s) : s(Re[t] + (e || ""))
  , Me = (t,e)=>{
...
const De = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"
  , Ue = "undefined" == typeof Uint8Array ? [] : new Uint8Array(256);
for (let t = 0; t < 64; t++)
    Ue[De.charCodeAt(t)] = t;
const Fe = "function" == typeof ArrayBuffer
  ...
  , Ge = (t,e)=>{
    var r;
    return Fe ? (r = (t=>{
        let e, r, s, n, o, i = .75 * t.length, a = t.length, l = 0;
        "=" === t[t.length - 1] && (i--,
        "=" === t[t.length - 2]) && i--;
        ...
        for (e = 0; e < a; e += 4)
            r = Ue[t.charCodeAt(e)],
            s = Ue[t.charCodeAt(e + 1)],
            n = Ue[t.charCodeAt(e + 2)],
            o = Ue[t.charCodeAt(e + 3)],
            h[l++] = r << 2 | s >> 4,
            h[l++] = (15 & s) << 4 | n >> 2,
            h[l++] = (3 & n) << 6 | 63 & o;
        return c
  ...
  , We = (t,e)=>"blob" !== e ? t instanceof ArrayBuffer ? t : t.buffer : t instanceof Blob ? t : new Blob([t])
  , Ve = String.fromCharCode(30);
function Ye() {
    return new TransformStream({
        transform(t, e) {
            !function(t, e) {
                Le && t.data instanceof Blob ? t.data.arrayBuffer().then(ze).then(e) : Ne && (t.data instanceof ArrayBuffer || je(t.data)) ? e(ze(t.data)) : Ie(t, !1, (t=>{
                    qe = qe || new TextEncoder,
                    e(qe.encode(t))
                }
                ))
            }(t, (r=>{
                var s, n = r.length;
                let o;
                n < 126 ? (o = new Uint8Array(1),
                new DataView(o.buffer).setUint8(0, n)) : n < 65536 ? (o = new Uint8Array(3),
                (s = new DataView(o.buffer)).setUint8(0, 126),
                s.setUint16(1, n)) : (o = new Uint8Array(9),
...
function Ke(t, e) {
    ...
    for (let n = 0; n < e; n++)
        r[n] = t[0][s++],
        s === t[0].length && (t.shift(),
        s = 0);
    return t.length && s < t[0].length && (t[0] = t[0].slice(s)),
    r
}
function Qe(t) {
    if (t)
...
;
const Ze = "undefined" != typeof self ? self : "undefined" != typeof window ? window : Function("return this")();
function tr(t, ...e) {
    return e.reduce(((e,r)=>(t.hasOwnProperty(r) && (e[r] = t[r]),
    e)), {})
}
const er = Ze.setTimeout
  , rr = Ze.clearTimeout;
function sr(t, e) {
    e.useNativeTimers ? (t.setTimeoutFn = er.bind(Ze),
    t.clearTimeoutFn = rr.bind(Ze)) : (t.setTimeoutFn = Ze.setTimeout.bind(Ze),
...
function nr(t) {
    return "string" == typeof t ? function(t) {
        ...
        for (let s = 0, n = t.length; s < n; s++)
            (e = t.charCodeAt(s)) < 128 ? r += 1 : e < 2048 ? r += 2 : e < 55296 || 57344 <= e ? r += 3 : (s++,
            r += 4);
        return r
...
class ir extends Qe {
    ...
    onError(t, e, r) {
        return super.emitReserved("error", new or(t,e,r)),
        this
    }
    open() {
...
const ar = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_".split("")
  , lr = 64
  , cr = {};
let hr, ur = 0, pr = 0;
function dr(t) {
...
let gr = !1;
try {
    gr = "undefined" != typeof XMLHttpRequest && "withCredentials"in new XMLHttpRequest
} catch (ue) {}
const br = gr;
function yr(t) {
    t = t.xdomain;
    try {
        if ("undefined" != typeof XMLHttpRequest && (!t || br))
...
class wr extends Qe {
    ...
    create() {
        var t, e = tr(this.opts, "agent", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "autoUnref");
        e.xdomain = !!this.opts.xd;
        const r = this.xhr = new yr(e);
        try {
            ...
            r.onreadystatechange = ()=>{
                var t;
                3 === r.readyState && null != (t = this.opts.cookieJar) && t.parseCookies(r),
                4 === r.readyState && (200 === r.status || 1223 === r.status ? this.onLoad() : this.setTimeoutFn((()=>{
        ...
        "undefined" != typeof document && (this.index = wr.requestsCount++,
        wr.requests[this.index] = this)
    }
    onError(t) {
    ...
    cleanup(t) {
        if (void 0 !== this.xhr && null !== this.xhr) {
            if (this.xhr.onreadystatechange = mr,
            t)
                try {
                    this.xhr.abort()
                } catch (t) {}
            "undefined" != typeof document && delete wr.requests[this.index],
            this.xhr = null
        }
    }
    onLoad() {
...
if (wr.requestsCount = 0,
wr.requests = {},
"undefined" != typeof document)
    if ("function" == typeof attachEvent)
        attachEvent("onunload", xr);
    else if ("function" == typeof addEventListener) {
        addEventListener("onpagehide"in Ze ? "pagehide" : "unload", xr, !1)
    }
function xr() {
    for (var t in wr.requests)
        wr.requests.hasOwnProperty(t) && wr.requests[t].abort()
}
const kr = "function" == typeof Promise && "function" == typeof Promise.resolve ? t=>Promise.resolve().then(t) : (t,e)=>e(t, 0)
  , _r = Ze.WebSocket || Ze.MozWebSocket
  , Cr = "undefined" != typeof navigator && "string" == typeof navigator.product && "reactnative" === navigator.product.toLowerCase();
const Sr = {
    websocket: class extends ir {
        constructor(t) {
            super(t),
        ...
        doOpen() {
            if (this.check()) {
                var t = this.uri()
                  ...
                  , r = Cr ? {} : tr(this.opts, "agent", "perMessageDeflate", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "localAddress", "protocolVersion", "origin", "maxPayload", "family", "checkServerIdentity");
                this.opts.extraHeaders && (r.headers = this.opts.extraHeaders);
                try {
                    this.ws = Cr ? new _r(t,e,r) : e ? new _r(t,e) : new _r(t)
                } catch (t) {
        ...
        uri() {
            var t = this.opts.secure ? "wss" : "ws"
              , e = this.query || {};
            return this.opts.timestampRequests && (e[this.opts.timestampParam] = fr()),
        ...
        doOpen() {
            ...
            this.transport.ready.then((()=>{
                this.transport.createBidirectionalStream().then((t=>{
                                ...
                                for (r.push(i); ; ) {
                                    if (0 === s) {
                                        ...
                                        if (Je(r) < 2)
                                            break;
                                        l = Ke(r, 2),
                                        n = new DataView(l.buffer,l.byteOffset,l.length).getUint16(0),
                                        s = 3
                                    } else if (2 === s) {
                                        if (Je(r) < 8)
                                            break;
                                        ...
                                        n = h * Math.pow(2, 32) + c.getUint32(4),
                                        s = 3
                                    } else {
                                        if (Je(r) < n)
                                            break;
                                        h = Ke(r, n),
                                        a.enqueue(He(o ? h : Xe.decode(h), e)),
                                        s = 0
                                    }
                                    if (0 === n || n > t) {
                                        a.enqueue(Be);
                    ...
                    (e = Ye()).readable.pipeTo(t.writable),
                    this.writer = e.writable.getWriter();
                    const s = ()=>{
                        r.read().then((({done: t, value: e})=>{
                            t || (this.onPacket(e),
                            s())
                        }
                        )).catch((t=>{}
    ...
    polling: class extends ir {
        ...
        uri() {
            var t = this.opts.secure ? "https" : "http"
              , e = this.query || {};
            return !1 !== this.opts.timestampRequests && (e[this.opts.timestampParam] = fr()),
  ...
  , Ar = /^(?:(?![^:@\/?#]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@\/?#]*)(?::([^:@\/?#]*))?)?@)?((?:[a-f0-9]{0,4}:){2,7}[a-f0-9]{0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/
  , Pr = ["source", "protocol", "authority", "userInfo", "user", "password", "host", "port", "relative", "path", "directory", "file", "query", "anchor"];
function $r(t) {
    var e = t
      , r = t.indexOf("[")
      , s = t.indexOf("]");
    ...
    o.pathNames = function(t, e) {
        ...
        return "/" != e.slice(0, 1) && 0 !== e.length || r.splice(0, 1),
...
let Er = class t extends Qe {
    constructor(t, e={}) {
        ...
        e.port = t.port,
        t.query && (e.query = t.query)) : e.host && (e.hostname = $r(e.host).host),
        sr(this, e),
    ...
    createTransport(t) {
        var e = ((e = Object.assign({}, this.opts.query)).EIO = 4,
        e.transport = t,
    ...
    open() {
        let e;
        if (this.opts.rememberUpgrade && t.priorWebsocketSuccess && -1 !== this.transports.indexOf("websocket"))
            e = "websocket";
        else {
    ...
    setTransport(t) {
        this.transport && this.transport.removeAllListeners(),
        (this.transport = t).on("drain", this.onDrain.bind(this)).on("packet", this.onPacket.bind(this)).on("error", this.onError.bind(this)).on("close", (t=>this.onClose("transport close", t)))
    }
    probe(e) {
        ...
        const n = ()=>{
            ...
            r.once("packet", (e=>{
                s || ("pong" === e.type && "probe" === e.data ? (this.upgrading = !0,
                this.emitReserved("upgrading", r),
                r && (t.priorWebsocketSuccess = "websocket" === r.name,
                this.transport.pause((()=>{
                    s || "closed" !== this.readyState && (h(),
                    this.setTransport(r),
                    r.send([{
                        type: "upgrade"
                    }]),
    ...
    onDrain() {
        ...
        (this.prevBufferLen = 0) === this.writeBuffer.length ? this.emitReserved("drain") : this.flush()
    }
    flush() {
        var t;
        "closed" !== this.readyState && this.transport.writable && !this.upgrading && this.writeBuffer.length && (t = this.getWritablePackets(),
...
const Tr = "function" == typeof ArrayBuffer
  , Rr = t=>"function" == typeof ArrayBuffer.isView ? ArrayBuffer.isView(t) : t.buffer instanceof ArrayBuffer
  , Or = Object.prototype.toString
  , Br = "function" == typeof Blob || "undefined" != typeof Blob && "[object BlobConstructor]" === Or.call(Blob)
  , Lr = "function" == typeof File || "undefined" != typeof File && "[object FileConstructor]" === Or.call(File);
function Nr(t) {
    return Tr && (t instanceof ArrayBuffer || Rr(t)) || Br && t instanceof Blob || Lr && t instanceof File
}
function jr(t, e) {
    if (t && "object" == typeof t)
        if (Array.isArray(t)) {
            ...
            if (t.toJSON && "function" == typeof t.toJSON && 1 === arguments.length)
                return jr(t.toJSON(), !0);
            for (const e in t)
                if (Object.prototype.hasOwnProperty.call(t, e) && jr(t[e]))
                    return !0
        }
    return !1
}
...
function Mr(t, e) {
    ...
    var n = {};
    for (const r in t)
        Object.prototype.hasOwnProperty.call(t, r) && (n[r] = Mr(t[r], e));
    return n
}
function zr(t, e) {
    return t.data = qr(t.data, e),
...
function qr(t, e) {
    if (t) {
        ...
        if (Array.isArray(t))
            ...
            for (const r in t)
                Object.prototype.hasOwnProperty.call(t, r) && (t[r] = qr(t[r], e))
    }
    return t
}
const Dr = ["connect", "connect_error", "disconnect", "disconnecting", "newListener", "removeListener"];
!function(t) {
...
class Fr extends Qe {
    ...
    add(t) {
        ...
        if ("string" == typeof t) {
            ...
            (!r && e.type !== Bt.BINARY_ACK || (e.type = r ? Bt.EVENT : Bt.ACK,
            this.reconstructor = new Hr(e),
    ...
    decodeString(t) {
        ...
        if (t.charAt(++e)) {
            if (s = this.tryParse(t.substr(e)),
            !Fr.isPayloadValid(r.type, s))
    ...
    static isPayloadValid(t, e) {
        ...
        case Bt.BINARY_EVENT:
            return Array.isArray(e) && ("number" == typeof e[0] || "string" == typeof e[0] && -1 === Dr.indexOf(e[0]));
        case Bt.ACK:
        case Bt.BINARY_ACK:
...
class Hr {
    ...
    takeBinaryData(t) {
        ...
        this.buffers.length === this.reconPack.attachments ? (t = zr(this.reconPack, this.buffers),
...
var Gr = Object.freeze({
    ...
    Encoder: class {
        ...
        encode(t) {
            return t.type !== Bt.EVENT && t.type !== Bt.ACK || !jr(t) ? [this.encodeAsString(t)] : this.encodeAsBinary({
...
class Yr extends Qe {
    ...
    subEvents() {
        var t;
        this.subs || (t = this.io,
        this.subs = [Wr(t, "open", this.onopen.bind(this)), Wr(t, "packet", this.onpacket.bind(this)), Wr(t, "error", this.onerror.bind(this)), Wr(t, "close", this.onclose.bind(this))])
    }
    get active() {
        return !!this.subs
    }
    ...
    emit(t, ...e) {
        ...
        var r, s;
        return e.unshift(t),
        !this._opts.retries || this.flags.fromQueue || this.flags.volatile ? ((t = {
            type: Bt.EVENT,
            data: e,
            options: {}
        }).options.compress = !1 !== this.flags.compress,
        "function" == typeof e[e.length - 1] && (r = this.ids++,
        s = e.pop(),
        this._registerAckCallback(r, s),
        t.id = r),
        s = this.io.engine && this.io.engine.transport && this.io.engine.transport.writable,
        (!this.flags.volatile || s && this.connected) && (this.connected ? (this.notifyOutgoingListeners(t),
        this.packet(t)) : this.sendBuffer.push(t)),
        this.flags = {}) : this._addToQueue(e),
        this
    }
    ...
    _addToQueue(t) {
        ...
        t.push(((t,...s)=>{
            if (r === this._queue[0])
                return null !== t ? r.tryCount > this._opts.retries && (this._queue.shift(),
    ...
    _drainQueue(t=!1) {
        var e;
        !this.connected || 0 === this._queue.length || (e = this._queue[0]).pending && !t || (e.pending = !0,
        e.tryCount++,
        this.flags = e.flags,
    ...
    emitEvent(t) {
        if (this._anyListeners && this._anyListeners.length)
            for (const e of this._anyListeners.slice())
                e.apply(this, t);
...
class Jr extends Qe {
    constructor(t, e) {
        ...
        this.randomizationFactor(null != (r = e.randomizationFactor) ? r : .5),
        this.backoff = new Xr({
    ...
    open(t) {
        if (!~this._readyState.indexOf("open")) {
            this.engine = new Er(this.uri,this.opts);
            const s = this.engine
              , n = this
              , o = (this._readyState = "opening",
    ...
    onopen() {
        ...
        this.emitReserved("open");
        var t = this.engine;
        this.subs.push(Wr(t, "ping", this.onping.bind(this)), Wr(t, "data", this.ondata.bind(this)), Wr(t, "error", this.onerror.bind(this)), Wr(t, "close", this.onclose.bind(this)), Wr(this.decoder, "decoded", this.ondecoded.bind(this)))
    }
    onping() {
        this.emitReserved("ping")
    }
    ...
    socket(t, e) {
        let r = this.nsps[t];
        return r ? this._autoConnect && !r.active && r.connect() : (r = new Yr(this,t,e),
        this.nsps[t] = r),
        r
    }
    _destroy(t) {
...
function Qr(t, e) {
    ...
    t = function(t, e="", r) {
        let s = t;
        return r = r || "undefined" != typeof location && location,
        "string" == typeof (t = null == t ? r.protocol + "//" + r.host : t) && ("/" === t.charAt(0) && (t = "/" === t.charAt(1) ? r.protocol + t : r.host + t),
        ...
        s.href = s.protocol + "://" + t + (r && r.port === s.port ? "" : ":" + s.port),
        s
    }(t, (e = e || {}).path || "/socket.io");
    var r = t.source
      , s = t.id
      , n = t.path;
    n = Kr[s] && n in Kr[s].nsps;
    let o;
    return o = (n = e.forceNew || e["force new connection"] || !1 === e.multiplex || n) ? new Jr(r,e) : (Kr[s] || (Kr[s] = new Jr(r,e)),
    Kr[s]),
...
const rs = t=>{
      ...
      , [s,n] = (A((()=>{
        e && (e.innerHTML = function(t) {
            return (t = (t = "string" != typeof t ? JSON.stringify(t, void 0, 2) : t).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;")).replace(/("(\\u[a-zA-Z0-9]{4}|\\[^u]|[^\\"])*"(\s*:)?|\b(true|false|null)\b|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?)/g, (function(t) {
                let e = "number";
                return /^"/.test(t) ? e = /:$/.test(t) ? "key" : "string" : /true|false/.test(t) ? e = "boolean" : /null/.test(t) && (e = "null"),
                '<span class="' + e + '">' + t + "</span>"
            }
            ))
  ...
  , ss = st("<div>")
  , ns = st('<span class="px-3 whitespace-pre-wrap font-semibold max-w-full">')
  , os = st("<span>Clear")
  , is = st('<div><div class="flex w-full h-full justify-center"><div class="overflow-y-scroll min-w-full w-full min-h-full px-3 pt-10 relative scrollable-container chatbot-chat-view scroll-smooth"></div><div><div>')
  , as = st('<div class="w-full h-32">')
  , ls = "Hi there! How can I help?"
  , cs = t=>{
    let e, r, s;
    const [n,o] = x("")
      , [i,a] = x(!1)
    ...
    ()=>{
      ...
      , E = async e=>{
        ...
        "" !== e.trim()) {
            ...
            s = (t.chatflowConfig && (s.overrideConfig = t.chatflowConfig),
            b() && (s.socketIOClientId = f()),
            await (({chatflowid: t, apiHost: e="http://localhost:3000", body: r})=>_t({
                method: "POST",
            ...
            if (s.data) {
                ...
                if (!b()) {
                    ...
                    d((r=>(r = [...r, {
                        ...
                        fileAnnotations: t?.fileAnnotations,
                        type: "apiMessage"
                    }],
                    S(r),
                    r)))
    ...
    _((async()=>{
        var e = ((e = localStorage.getItem(t.chatflowid + "_EXTERNAL")) && (e = JSON.parse(e),
        v(e.chatId),
        e = e.chatHistory.map((t=>{
            ...
            return t.sourceDocuments && (e.sourceDocuments = t.sourceDocuments),
            t.fileAnnotations && (e.fileAnnotations = t.fileAnnotations),
            e
        }
        )),
        d([...e])),
        await (({chatflowid: t, apiHost: e="http://localhost:3000"})=>_t({
            method: "GET",
    ...
    return [(()=>{
        const o = is()
          ...
          , d = h.firstChild;
        var f;
        return "function" == typeof (f = ("function" == typeof (f = s) ? lt(f, o) : s = o,
        e)) ? lt(f, l) : e = l,
        ...
        ct(l, U(Y, {
            ...
            children: (e,r)=>[C((()=>{
                ...
                return ()=>{
                    return t() && ((r = ss()).style.setProperty("display", "flex"),
                    ...
                    ct(r, U(Y, {
                        get each() {
                            return [...(t=>{
                                ...
                                return t.sourceDocuments.forEach((t=>{
                                    R(t.metadata.source) && !e.includes(t.metadata.source) ? (e.push(t.metadata.source),
                                    r.push(t)) : R(t.metadata.source) || r.push(t)
                                }
                                )),
                                r
                            }
                        ...
                        children: t=>{
                            ...
                            return U(Pe, {
                                ...
                                onSourceClick: ()=>{
                                    e ? window.open(t.metadata.source, "_blank") : (u(t),
                                    c(!0))
                                }
                            })
                        }
        ...
        h.style.setProperty("height", "50px"),
        h.style.setProperty("top", "0"),
        h.style.setProperty("left", "0"),
        ...
        k((e=>{
            ...
            return r !== e._v$ && it(o, e._v$ = r),
            s !== e._v$2 && (null != (e._v$2 = s) ? h.style.setProperty("position", s) : h.style.removeProperty("position")),
            n !== e._v$3 && (null != (e._v$3 = n) ? h.style.setProperty("background", n) : h.style.removeProperty("background")),
            i !== e._v$4 && (null != (e._v$4 = i) ? h.style.setProperty("color", i) : h.style.removeProperty("color")),
            a !== e._v$5 && (null != (e._v$5 = a) ? h.style.setProperty("border-top-left-radius", a) : h.style.removeProperty("border-top-left-radius")),
            l !== e._v$6 && (null != (e._v$6 = l) ? h.style.setProperty("border-top-right-radius", l) : h.style.removeProperty("border-top-right-radius")),
            e
        }
        ), {
            _v$: void 0,
  ...
  , hs = t=>{
    return e = as(),
    "function" == typeof (r = t.ref) ? lt(r, e) : t.ref = e,
    e;
    var e, r
}
  , us = st("<style>")
  ...
  , ds = t=>{
    ...
    i), U(Pt, W((()=>e.theme?.button), {
        ...
        const s = ps();
        return s.style.setProperty("transition", "transform 200ms cubic-bezier(0, 1.2, 1, 1), opacity 150ms ease-out"),
        ...
        k((n=>{
            ...
            return o !== n._v$ && (null != (n._v$ = o) ? s.style.setProperty("height", o) : s.style.removeProperty("height")),
            i !== n._v$2 && (null != (n._v$2 = i) ? s.style.setProperty("transform", i) : s.style.removeProperty("transform")),
            a !== n._v$3 && (null != (n._v$3 = a) ? s.style.setProperty("background-color", a) : s.style.removeProperty("background-color")),
  ...
  , bs = (t,{element: e})=>{
    ...
    o), U(X, {
        ...
        get children() {
            const e = gs();
            return e.style.setProperty("margin", "0px"),
            ct(e, U(cs, {
                get badgeBackgroundColor() {
            ...
            k((r=>{
                ...
                return s !== r._v$ && (null != (r._v$ = s) ? e.style.setProperty("background-color", s) : e.style.removeProperty("background-color")),
                n !== r._v$2 && (null != (r._v$2 = n) ? e.style.setProperty("height", n) : e.style.removeProperty("height")),
                o !== r._v$3 && (null != (r._v$3 = o) ? e.style.setProperty("width", o) : e.style.removeProperty("width")),
                r
            }
            ), {
                _v$: void 0,
  ...
  , ys = t=>{
    ...
    if (!e)
        throw new Error("<flowise-fullchatbot> element not found.");
    Object.assign(e, t)
}
  , ms = t=>{
  ...
  , vs = ("undefined" != typeof window && (mt("flowise-fullchatbot", vt, bs),
mt("flowise-chatbot", vt, ds)),
{
    initFull: ys,
    init: ms
});
